...
.sol-card__tier { flex: none; font-family: var(--font-mono); font-size: 9.5px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; padding: 4px 8px; border: 2px solid var(--ink-border); border-radius: 999px; color: var(--ink-muted); background: transparent; }
.sol-card__tier.is-demo { background: var(--accent-green); color: var(--btn-ink); }

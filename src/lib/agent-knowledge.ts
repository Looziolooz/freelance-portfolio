...
const RAW: RawEntry[] = [
  ...
  },
  {
    ...
    it: "Brado è il sito di un'hamburgeria di Modena (dal 2016): manzo 100% italiano da allevamento brado cotto sulla brace di faggio e pane lievitato in casa. Hero cinematico, menù, racconto della materia prima e prenotazione del tavolo. Costruito con Next.js 16 e Tailwind 4.",
    en: "Brado is the website of a Modena burger joint (since 2016): 100% Italian grass-fed beef charcoal-grilled over beechwood and house-leavened bread. Cinematic hero, menu, sourcing story and table booking. Built with Next.js 16 and Tailwind 4.",

...
export const ALL_SOLUTIONS: Solution[] = [
  ...
  // Automazioni e dati
  { slug: "automatizzare-excel", key: "excel", family: "automazioni-ai", sectors: OVUNQUE, nearest: ["mappa-mercato", "solleciti-pagamento"], draft: true },
  ...
  { slug: "crm-pmi", key: "crm", family: "software", sectors: OVUNQUE, nearest: ["barberia", "ai-visibility"], draft: true },
  { slug: "dashboard-kpi", key: "kpi", family: "software", sectors: OVUNQUE, nearest: ["ai-visibility", "weather-se"], draft: true },
  ...
  { slug: "gestionale-turni", key: "turni", family: "software", sectors: ["sanita", "ristorazione"], nearest: ["barberia", "yoga"], draft: true },
  ...
  { slug: "gestionale-hotel-pms", key: "pms", family: "software", sectors: ["turismo"], nearest: ["bella-calabria", "buss-travel"], draft: true },
  { slug: "gestionale-palestra", key: "gestPalestra", family: "software", sectors: ["benessere-sport"], nearest: ["yoga", "barberia"], draft: true },
  { slug: "gestionale-clinica", key: "clinica", family: "software", sectors: ["sanita"], nearest: ["barberia", "yoga"], draft: true },
  { slug: "tracciabilita-haccp", key: "haccp", family: "software", sectors: ["ristorazione", "produttori-food"], nearest: ["barberia", "aliva"], draft: true },
  ...
  { slug: "gestionale-dentistico", key: "dentistico", family: "software", sectors: ["sanita"], nearest: ["barberia", "yoga"], draft: true },
  { slug: "gestionale-estetica", key: "estetica", family: "software", sectors: ["servizi-persona", "benessere-sport"], nearest: ["barberia", "yoga"], draft: true },

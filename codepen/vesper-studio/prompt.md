Create a React + Vite + TypeScript + Tailwind CSS landing page for a creative studio called "Vesper". The page has 3 sections: Hero, About, and Features. Use framer-motion for animations and lucide-react for icons. The design is dark, moody, and cinematic with a warm cream colour palette.
...
Primary text colour: #E1E0CC (applied via inline style, slightly different from Tailwind primary)
Tailwind primary: #DEDBC8 (used for utility classes like text-primary, text-primary/70)
Gray text: text-gray-400, text-gray-500
Navbar link colour: rgba(225, 224, 204, 0.8) with hover: #E1E0CC
...
Absolutely positioned at top centre
...
Link colour: rgba(225, 224, 204, 0.8), hover: #E1E0CC (inline styles)
...
Giant heading "Vesper" using WordsPullUp component:
...
Colour: #E1E0CC
Has a superscript asterisk (*) on the final "r" of "Vesper": positioned with absolute top-[0.65em] -right-[0.3em] text-[0.31em]
...
"Vesper is a worldwide network of visual artists, filmmakers and storytellers bound not by place or label but by the hunger to unlock potential through a shared and singular point of view."
...
bg-black, padded section with centred content
Inner card: bg-[#101010], centred text, max-w-6xl
...
"I am Elia Vento," -- font-normal (Almarai)
"a self-taught director." -- italic font-serif (Instrument Serif italic)
"I have skills in colour grading, visual effects, and narrative design." -- font-normal
...
Text: "Over the last seven years I have worked with Lumen Atelier, a Berlin-based production house that crafts cinema and series, and with Vela Studio in Paris. Together we have created work that has earned acclaim at several major festivals."
...
Card 2 - "Project Storyboard." (01): bg-[#212121], small image icon at top (https://images.unsplash.com/photo-1485846234645-a62644f84728?w=400&q=85&fm=webp, 10x10 sm:12x12 rounded), title with number, 4 checklist items with cream Check icons ("Scene-by-scene shot planning", "Frame references and mood boards", "Shared timeline with the collective", "Version history on every cut"), "Learn more" link with rotated arrow (-45deg).

Card 3 - "Smart Critiques." (02): Same layout as Card 2. Icon: https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=400&q=85&fm=webp. 3 checklist items ("Frame-level analysis of your edit", "Creative notes from the network", "Direct hooks into your tools").

Card 4 - "Immersion Capsule." (03): Same layout. Icon: https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=400&q=85&fm=webp. 3 checklist items ("Silence every notification", "Ambient soundscapes on tap", "Sessions that sync to your schedule").

All feature card checklist items use Check icon from lucide-react in text-primary colour, with text-gray-400 description text. "Learn more" buttons use ArrowRight rotated -45deg.

SHARED ANIMATION COMPONENTS

WordsPullUp: Splits text by spaces, each word is a motion.span that slides up (y:20 to 0) with staggered delay. Uses useInView (once: true). Supports showAsterisk prop that adds a superscript * after the last character of the final word.

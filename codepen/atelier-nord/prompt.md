Create a fullscreen hero landing page for an architecture and interiors studio called "Atelier Nord" using React, Tailwind CSS, and Lucide React icons. The page is a single viewport-height section with a looping background video, a responsive navbar, a mobile menu, and staggered-animated hero text.
...
- Add a `poster` for first paint: `https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=1280&q=85&fm=webp`
...
- Left side: Logo text "Atelier Nord" (`text-lg font-semibold tracking-tight text-white sm:text-xl`) followed by desktop nav links (hidden on mobile, flex on md+)
...
- Badge: "Spaces & Visual Storytelling" (`text-xs sm:text-sm text-white/90`), with `animate-[fadeSlideUp_0.8s_ease_0.2s_both]`, margin-bottom 4 (sm:6)
- Heading h1: "Shaping quiet / spaces, one / line at a time." with `<br/>` line breaks
...
**Bottom Section:**
- Paragraph: "Turning a brief into a place worth lingering in, through craft, material, and a long patience for light."
